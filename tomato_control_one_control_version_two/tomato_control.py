...
"""
    ...
    \begin{equation}
        \begin{aligned}
            \frac{dS_p}{dt} &=
                -a S_p I_v +\beta L_p + \beta I_p,
            \\
            \frac{dL_p}{dt} &=
                a S_pI_v -bL_p -\beta L_p,
            \\
            \frac{dI_p}{dt} &=
                b L_p - \beta I_p,
            \\
...
class OptimalControlProblem(object):
    ...
    def g(self, x_k, u_k):
        ...
        rhs_s_p = - a * s_p * i_v + beta * l_p + beta * i_p
        rhs_l_p = a * s_p * i_v - b * l_p - beta * l_p
        rhs_i_p = b * l_p - beta * i_p
    ...
    def lambda_function(self, x_k, u_k, lambda_k):
        ...
        rhs_l_2 = - A_2 + beta * (lambda_2 - lambda_1) + b * (lambda_2 - lambda_3)

        rhs_l_3 = - A_1 + beta * (lambda_3 - lambda_1) + psi * s_v * (lambda_4 - lambda_5)
